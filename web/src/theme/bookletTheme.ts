...
const ITINERARY_LAYOUTS = new Map<
	ItineraryLayoutDefinition["id"],
	ItineraryLayoutDefinition
>([
	["split-forward", { id: "split-forward" }],
	["split-reverse", { id: "split-reverse" }],
	["route-rail", { id: "route-rail" }],
	["center-column", { id: "center-column" }],
	["upper-right", { id: "upper-right" }],
	["lower-right", { id: "lower-right" }],
	["stacked-ledger", { id: "stacked-ledger" }],
]);
...
export const THEME_RECIPES_V1: readonly ThemeRecipeDefinition[] = Object.freeze(
	[
		recipe({
			...
			fontPairId: "classic",
			id: "field-01",
			itineraryLayoutId: "split-forward",
			paletteId: "paper-ink",
		...
		recipe({
			...
			fontPairId: "literary",
			id: "field-04",
			itineraryLayoutId: "center-column",
		...
		recipe({
			...
			fontPairId: "classic",
			id: "postcard-04",
			itineraryLayoutId: "split-reverse",
			paletteId: "marine-glass",
			signatureId: "postcard",
		}),
		recipe({
...
export function getBookletThemeCssVariables(
	...
	return Object.freeze({
		...
		"--booklet-cover-panel": palette.coverPanel,
		"--booklet-cover-panel-opacity": `${palette.coverPanelOpacity}`,
