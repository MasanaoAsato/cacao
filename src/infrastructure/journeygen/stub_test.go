...
func TestStub_Generate(t *testing.T) {
	generator := NewStub()
...
func TestStub_Generate_SingleDay(t *testing.T) {
	generator := NewStub()
	start := time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC)
...
func TestStub_Generate_LongPeriod(t *testing.T) {
	generator := NewStub()
	start := time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC)
...
func TestStub_Generate_TinyBudget(t *testing.T) {
	generator := NewStub()
	start := time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC)
	end := time.Date(2026, 7, 1, 0, 0, 0, 0, time.UTC)
...
func TestStub_Generate_Error(t *testing.T) {
	generator := NewStub()
